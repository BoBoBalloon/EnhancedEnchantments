...
public class AllSeeingEyeEnchant extends HelmetEnchantment {
    ...
    public AllSeeingEyeEnchant() {
        super("All Seeing Eye", 1, EnchantmentTier.COMMON, ArmorEnchantmentTrigger.EVERY_SECOND, Collections.singletonList("This enchantment will give you permanent night vision"));
    }
